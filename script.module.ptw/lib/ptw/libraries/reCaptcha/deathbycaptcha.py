...
class captchaSolver(reCaptcha):
    ...
    def reportJob(self, jobID):
        ...
        if response:
            ...
            raise reCaptchaReportError("DeathByCaptcha: Error report failed reCaptcha.")
    ...
    def requestJob(self, jobID):
        ...
        if response:
            ...
            raise reCaptchaTimeout("DeathByCaptcha: Error failed to solve reCaptcha.")
    ...
    def requestSolve(self, url, siteKey):
        ...
        response = polling.poll(
            lambda: self.session.post(
                ...
                data={
                    ...
                    "type": "4",
                    "token_params": json.dumps({"googlekey": siteKey, "pageurl": url}),
                },
        ...
        if response:
            ...
            raise reCaptchaBadJobID("DeathByCaptcha: Error no job id was returned.")
    ...
    def getCaptchaAnswer(self, captchaType, url, siteKey, reCaptchaParams):
        ...
        if captchaType == "hCaptcha":
            raise reCaptchaException("Provider does not support hCaptcha.")
        ...
        try:
            ...
            raise reCaptchaTimeout(
                "DeathByCaptcha: reCaptcha solve took to long to execute job id {}, aborting.".format(
                    jobID
                )
            )
