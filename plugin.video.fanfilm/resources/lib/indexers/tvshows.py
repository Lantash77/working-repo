...
#        self.tvdb_image = "http://thetvdb.com/banners/"
        ...
        self.popular_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=100,&release_date=,date[0]&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.airing_link = (
            "https://www.imdb.com/search/title?title_type=tv_episode&release_date=date[1],date[0]&sort=moviemeter,asc&count="
            + listscount
            + "&start=1"
        )
        self.active_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=10,&production_status=active&sort=moviemeter,asc&count="
            + listscount
            + "&start=1"
        )
        ...
        self.premiere_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&languages=en&num_votes=10,&release_date=date[60],date[0]&sort=release_date,desc&count="
            + listscount
            + "&start=1"
        )
        self.rating_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=5000,&release_date=,date[0]&sort=user_rating,desc&count="
            + listscount
            + "&start=1"
        )
        self.views_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=100,&release_date=,date[0]&sort=num_votes,desc&count="
            + listscount
            + "&start=1"
        )
        self.person_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&role=%s&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.genre_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=%s&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.keyword_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&keywords=%s&sort=moviemeter,asc&count="
            + listscount
            + "&start=1"
        )
        self.language_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=100,&production_status=released&primary_language=%s&"
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.certification_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&certificates=us:%s&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        #       self.year_link = 'TEST'
        self.action_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=action&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.adventure_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=adventure&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.animation_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=animation&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.anime_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&keywords=anime&sort=moviemeter,asc&count="
            + listscount
            + "&start=1"
        )
        self.biography_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=biography&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.comedy_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=comedy&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.crime_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=crime&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.drama_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=drama&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.family_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=family&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.fantasy_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=fantasy&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.game_show_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=game_show&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.history_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=history&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.horror_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=horror&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.music_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=music&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.musical_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=musical&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.mystery_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=mystery&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.news_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=news&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        )
        self.reality_tv_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=reality_tv&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.romance_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=romance&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.sci_fi_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=sci_fi&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.sport_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=sport&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.talk_show_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=talk_show&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.thriller_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=thriller&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.war_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=war&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.western_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=western&sort="
            + tvshowssort
            + "&count="
            + listscount
            + "&start=1"
        ...
        self.traktlikedlists_link = (
            "https://api.trakt.tv/users/likes/lists?limit=1000000"
        )
        ...
        self.imdbUserLists_link = (
            "https://www.imdb.com/list/%s/?view=detail&sort=alpha,asc&title_type=tvSeries,miniSeries&count="
            + listscount
            + "&start=1"
        )

        self.y50_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=1950-01-01,1959-12-31&sort=moviessort,asc&count="
            + listscount
            + "&start=1"
        )
        self.y60_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=1960-01-01,1969-12-31&sort=moviessort,asc&count="
            + listscount
            + "&start=1"
        )
        self.y70_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=1970-01-01,1979-12-31&sort=moviessort,asc&count="
            + listscount
            + "&start=1"
        )
        self.y80_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=1980-01-01,1989-12-31&sort=moviessort,asc&count="
            + listscount
            + "&start=1"
        )
        self.y90_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=1990-01-01,1999-12-31&sort=moviessort,asc&count="
            + listscount
            + "&start=1"
        )
        self.y2000_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=2000-01-01,2009-12-31&sort=moviessort,asc&count="
            + listscount
            + "&start=1"
        )
        self.y2010_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=2010-01-01,2019-12-31&sort=moviessort,asc&count="
            + listscount
            + "&start=1"
        )
        self.y2020_link = (
            "https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=2020-01-01,date[90]&sort=moviessort,asc&count="
            + listscount
            + "&start=1"
        )
...
#                self.tvdb_login(username_tvdb, user_key_tvdb, api_key_tvdb)
    ...
    def search(self):
        ...
        try:
            dbcur.executescript(
                "CREATE TABLE IF NOT EXISTS tvshow (ID Integer PRIMARY KEY AUTOINCREMENT, term);"
            )
        except:
            pass
    ...
    def search_term(self, name):
        ...
        url = "%s?action=tvshowPage&url=%s" % (sys.argv[0], quote_plus(url))
        tvshows.get(self, self.search_link + quote_plus(name))
...
#        return self.list
    ...
    def my_imdbUserLists(self):
        ...
        if tvlist1:
            self.list.append(
                {
                    "name": tvlist1,
                    "url": self.imdbUserLists_link % tvlist1_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
        ...
        if tvlist2:
            self.list.append(
                {
                    "name": tvlist2,
                    "url": self.imdbUserLists_link % tvlist2_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
        ...
        if tvlist3:
            self.list.append(
                {
                    "name": tvlist3,
                    "url": self.imdbUserLists_link % tvlist3_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
        ...
        if tvlist4:
            self.list.append(
                {
                    "name": tvlist4,
                    "url": self.imdbUserLists_link % tvlist4_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
        ...
        if tvlist5:
            self.list.append(
                {
                    "name": tvlist5,
                    "url": self.imdbUserLists_link % tvlist5_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
        ...
        if tvlist6:
            self.list.append(
                {
                    "name": tvlist6,
                    "url": self.imdbUserLists_link % tvlist6_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
        ...
        if tvlist7:
            self.list.append(
                {
                    "name": tvlist7,
                    "url": self.imdbUserLists_link % tvlist7_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
        ...
        if tvlist8:
            self.list.append(
                {
                    "name": tvlist8,
                    "url": self.imdbUserLists_link % tvlist8_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
        ...
        if tvlist9:
            self.list.append(
                {
                    "name": tvlist9,
                    "url": self.imdbUserLists_link % tvlist9_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
        ...
        if tvlist10:
            self.list.append(
                {
                    "name": tvlist10,
                    "url": self.imdbUserLists_link % tvlist10_link,
                    "image": "imdb.png",
                    "action": "tvshows",
                }
            )
    ...
    def genres(self):
        ...
        self.list.append(
            {"name": "Anime", "url": "anime", "image": "anime.jpg", "action": "tvshows"}
        )
        self.list.append(
            {
                "name": "Biograficzny",
        ...
        self.list.append(
            {"name": "News", "url": "news", "image": "news.jpg", "action": "tvshows"}
        )
        self.list.append(
            {
                "name": "Reality-TV",
        ...
        self.list.append(
            {"name": "Sport", "url": "sport", "image": "sport.jpg", "action": "tvshows"}
        )
        self.list.append(
            {
                "name": "Talk-Show",
        ...
        self.list.append(
            {"name": "Wojenny", "url": "war", "image": "war.jpg", "action": "tvshows"}
        )
        self.list.append(
            {
                "name": "Western",
    ...
    def imdb_list(self, url):
        ...
        try:
            ...
            next = url.replace(
                urlparse(url).query, urlparse(next[0]).query
            )
...
#                content = content.encode("utf-8")
        ...
        try:
            ...
            threads = []
            for i in items:
                threads.append(threading.Thread(target=items_list, args=(i,)))
...
#                i.update({"clearlogo": "0", "clearart": "0"})
    ...
    def super_info(self, i):
        try:
            ...
            if tmdb == '0':
                try:
                    url = self.search_link % (quote(list_title)) + '&first_air_date_year=' + self.list[i]['year']
                    result = self.session.get(url, timeout=10).json()
...
#            if self.hq_artwork == 'true' and not tvdb == '0':# and not self.fanart_tv_user == '':
            ...
            log_utils.log('superinfo_fail %s' % e, 'indexer')
            pass

#            if imdb == '0':
#                try:
#                    imdb = trakt.SearchTVShow(
#                        quote_plus(self.list[i]['title']),
#                        self.list[i]['year'],
#                        full=False)[0]
    ...
    def tvshowDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                imdb, tvdb, tmdb, year = i["imdb"], i["tvdb"], i["tmdb"], i["year"]
                ...
                banner = i.get('banner', '') or fanart or addonBanner
