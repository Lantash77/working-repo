...
class indexer:
        ...
        if u:
            ...
            r = [
                (
                    ...
                    dom_parser.parse_dom(i, "span", {"class": "tMeterScore"}),
                    dom_parser.parse_dom(i, "img", req="src"),
                    dom_parser.parse_dom(i, "div", {"class": ["info", "synopsis"]}),
                )
                for i in u
            ]
            r = [
    ...
    def trakt_list(self, url):
        ...
        r = [
            (i.attrs["data-runtime"], dom_parser.parse_dom(i, "img", {"class": "real"}))
            for i in u
        ]
        r = [
            (
    ...
    def imdb_list(self, url):
        ...
        r = [
            (
                dom_parser.parse_dom(i, "div", {"class": "hover-over-image"}),
                dom_parser.parse_dom(i, "a", req="href"),
        ...
        r = [
            (
                ...
                i[1][1].text,
                re.findall("(\d+)", i[2][0].text)[0],
                re.sub("<.+?>", "", i[3][0].text),
                i[4][0].attrs["loadlate"]
                if "loadlate=" in i[4][0].text
