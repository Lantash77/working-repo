...
class source:
    def __init__(self):
        ...
        self.search_link = base64.b64decode(
            "L2FwaT9rZXk9NEIwQkI4NjJGMjRDOEEyOSZrZXl3b3JkPQ=="
        )
    ...
    def request(self, url, post=None, cookie=None, referer=None, output="", close=True):
        try:
            ...
            result = client.request(
                url, post=post, headers=headers, output=output, close=close
            )
                ...
                try:
                    ...
                    for link in links:
                        try:
                            ...
                            host = re.findall(
                                "([\w]+[.][\w]+)$",
                                urlparse.urlparse(url.strip().lower()).netloc,
                            )[0]
