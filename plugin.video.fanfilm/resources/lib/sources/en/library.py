...
from ptw.libraries import cleantitle, control
...
class source:
    ...
    def movie(self, imdb, title, localtitle, aliases, year):
        try:
            return urlencode(
                {"imdb": imdb, "title": title, "localtitle": localtitle, "year": year}
            )
        except:
            return
        ...
        try:
            ...
            if content_type == "movie":
                ...
                r = [
                    i
                    for i in r
                    if str(i["imdbnumber"]) in ids
                    or title
                    in [
                        cleantitle.get(ensure_str(i["title"])),
