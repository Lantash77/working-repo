            ...
            if not str(url).startswith("http"):
                ...
                if "tvshowtitle" in data:
                    ...
                    if pages == []:
                        ...
                        r = [
                            (i, re.findall("watch-tvshow-(.+?)-\d+\.html", i))
                            for i in r
                        ]
                        r = searchname(r)
                    else:
                    ...
                    if pages == []:
                        ...
                        r = [
                            (i, re.findall("watch-movie-(.+?)-\d+\.html", i)) for i in r
                        ]
                        r = searchname(r)
                    else:
                        for page in pages:
                            ...
                            r = re.findall("(watch-movie-.+?-\d+\.html)", r)
                            r = [
                                (i, re.findall("watch-movie-(.+?)-\d+\.html", i))
                                for i in r
                            ]
                            r = searchname(r)
                            if r != []:
                ...
                if "season" in data and "episode" in data:
                    ...
                    r = [
                        i
                        for i in r
                        if "-s%02de%02d-" % (int(data["season"]), int(data["episode"]))
                        in i.lower()
                    ][0]
